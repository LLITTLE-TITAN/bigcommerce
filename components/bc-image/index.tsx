...
type Props = NextImageProps & BcImageOptions & { sx?: string };
 ...
 */
export const BcImage = ({ sx, ...props }: Props) => {
  const [isImageLoading, setImageLoading] = useState(true);

  return (
    <Image
      className={`${sx || ''} ${isImageLoading ? 'blur' : 'remove-blur '}`}
      loader={bcCdnImageLoader}
